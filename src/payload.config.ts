...
export default buildConfig({
  ...
  collections: [
    ...
    },
    {
      ...
      admin: { useAsTitle: 'title', defaultColumns: ['order', 'title', 'client'] },
      access: { read: anyone, create: authenticated, update: authenticated, delete: authenticated },
      fields: [
        { name: 'title', type: 'text', required: true },
        {
          ...
          unique: true,
          index: true,
          admin: { description: 'Anchor id on /success-stories, e.g. "turning-friction-into-clarity" → /success-stories#turning-friction-into-clarity' },
        },
        { name: 'order', type: 'number', required: true, admin: { description: 'Display order (1 = first)' } },
        { name: 'client', type: 'text', required: true },
        { name: 'industry', type: 'text' },
        { name: 'theme', type: 'text' },
        { name: 'excerpt', type: 'textarea', admin: { description: 'One-line teaser shown on the homepage story cards' } },
        {
          name: 'milestones',
          type: 'array',
