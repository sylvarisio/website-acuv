...
<div data-screen-label="Article Hero" style={{ background: '#07332C', color: '#EAF4F0', position: 'relative', overflow: 'hidden' }}>
  ...
  <div className="acv-pad" style={{ position: 'relative', maxWidth: '1200px', margin: '0 auto', padding: '64px 56px 120px' }}>
    ...
    <div className="acv-h-md" style={{ fontWeight: '300', fontSize: '56px', lineHeight: '1.08', letterSpacing: '-.025em', maxWidth: '860px', textWrap: 'pretty' }}>{thought.title}</div>
...
<div className="acv-pad" data-screen-label="Article Body" style={{ maxWidth: '860px', margin: '0 auto', padding: '72px 56px 96px' }}>
