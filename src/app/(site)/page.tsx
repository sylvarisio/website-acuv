...
<div data-screen-label="Hero" style={{ background: '#07332C', color: '#EAF4F0', position: 'relative', overflow: 'hidden' }}>
  ...
  <SiteNav active="home" />
  <div className="acv-pad acv-duo" style={{ position: 'relative', maxWidth: '1200px', margin: '0 auto', padding: '96px 56px 0', display: 'grid', gridTemplateColumns: '1fr 300px', gap: '64px', alignItems: 'end' }}>
    <div>
  ...
  <div className="acv-pad" style={{ position: 'relative', maxWidth: '1200px', margin: '0 auto', padding: '56px 56px 0' }}>
  ...
  <div className="acv-pad acv-cols-4" style={{ position: 'relative', maxWidth: '1200px', margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 1fr', padding: '0 56px 36px' }}>
...
<div data-screen-label="Welcome" style={{ position: 'relative', overflow: 'hidden' }}>
  ...
  <div className="acv-pad acv-duo" style={{ position: 'relative', maxWidth: '1200px', margin: '0 auto', padding: '104px 56px 0', display: 'grid', gridTemplateColumns: '380px 1fr', gap: '72px' }}>
    <div>
      <div style={{ fontFamily: 'var(--font-sans)', fontSize: '11px', letterSpacing: '.2em', color: '#0E6B5A', marginBottom: '20px' }}>WELCOME TO ACUV</div>
      <div className="acv-h-sm" style={{ fontSize: '42px', fontWeight: '300', lineHeight: '1.15', letterSpacing: '-.015em' }}>We believe in <span style={{ fontFamily: 'var(--font-sans)', fontStyle: 'italic', color: '#0A4A3F' }}>confident growth</span></div>
...
<div className="acv-pad" data-screen-label="Programs" style={{ maxWidth: '1200px', margin: '0 auto', padding: '104px 56px 0' }}>
  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', marginBottom: '40px', gap: '20px', flexWrap: 'wrap' }}>
...
<div data-screen-label="Why acuv" style={{ position: 'relative', overflow: 'hidden' }}>
  <div className="acv-pad acv-duo" style={{ position: 'relative', maxWidth: '1200px', margin: '0 auto', padding: '104px 56px 0', display: 'grid', gridTemplateColumns: '340px 1fr', gap: '72px' }}>
    ...
    <div style={{ display: 'flex', flexDirection: 'column' }}>
      ...
      <div className="acv-section" style={{ padding: '24px 0', borderTop: '1px solid rgba(18,42,36,.15)', borderBottom: '1px solid rgba(18,42,36,.15)', display: 'grid', gridTemplateColumns: '280px 1fr', gap: '32px' }}><div style={{ fontSize: '16px', fontWeight: '500' }}>Proven outcomes</div><div style={{ fontSize: '13.5px', lineHeight: '1.7', color: 'rgba(18,42,36,.6)' }}>32% YoY revenue growth; capital raised 18% above benchmark.</div></div>
    </div>
  </div>
</div>


<div className="acv-pad" data-screen-label="Proof" style={{ maxWidth: '1200px', margin: '0 auto', padding: '104px 56px 96px' }}>
  <div className="acv-cols-3" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '24px' }}>
  ...
  <div className="acv-cols-3" style={{ marginTop: '24px', display: 'grid', gridTemplateColumns: '1.5fr 1fr 1fr', gap: '24px' }}>
...
<div data-screen-label="CTA" style={{ background: '#07332C', color: '#EAF4F0', position: 'relative', overflow: 'hidden' }}>
  ...
  <div className="acv-pad" style={{ position: 'relative', maxWidth: '1200px', margin: '0 auto', padding: '110px 56px 96px' }}>
    <div className="acv-cta" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', gap: '64px', borderTop: '1px solid rgba(159,217,198,.25)', paddingTop: '48px' }}>
      <div className="acv-h-md" style={{ fontWeight: '300', fontSize: '72px', lineHeight: '1.05', letterSpacing: '-.025em' }}>Ready to build<br />something <span style={{ fontFamily: 'var(--font-sans)', fontStyle: 'italic', fontWeight: '400', color: '#9FD9C6' }}>big</span>?</div>
